  ...
  return (
    <div className="flex justify-center">
      <motion.nav
        ...
        className="bg-background/50 backdrop-blur-xs text-foreground flex items-center justify-between h-14 sm:h-16 z-50 w-[95%] sm:w-[90%] md:w-[85%] max-w-[912px] fixed top-2 sm:top-4 rounded-lg shadow-md border border-border px-2"
      >
