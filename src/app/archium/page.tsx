            ...
            >
              ...
              <div className="flex justify-center gap-4 mt-6">
                <Button variant="default" className="h-8 gap-2" asChild>
                  <Link
                    href="https://github.com/q4ow/archium"
                    target="_blank"
                ...
                <Button variant="outline" className="h-8 gap-2" asChild>
                  <Link
                    href="https://github.com/q4ow/archium#%EF%B8%8F-installation"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center"
                  >
          ...
          <TabsContent value="installation">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Follow these steps to install Archium
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div>
                  ...
                  <pre className="bg-muted p-3 rounded-md overflow-x-auto font-mono text-sm relative pb-4">
                    git clone https://github.com/q4ow/archium.git cd archium
                    <CopyButton
                      textToCopy={
          ...
          <TabsContent value="usage">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  How to use Archium effectively
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div>
                  <p className="mb-2">
                    When you run{" "}
                    <code className="bg-muted px-1 rounded">archium</code>, you
                    will see:
                  </p>
                    ...
                    <table className="min-w-full divide-y divide-border">
                      ...
                      <tbody className="divide-y divide-border">
                        <tr>
                          ...
                          <td className="px-4 py-2">
                            Update the system or a specific package
                          </td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2">
              ...
              <CardFooter>
                <Button variant="outline" asChild>
                  <Link
                    href="https://github.com/q4ow/archium#-usage"
                    target="_blank"
                  >
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <p className="mb-2">
                      Archium uses{" "}
                      <code className="bg-muted px-1 rounded">yay</code> by
                      default. To use{" "}
                      <code className="bg-muted px-1 rounded">paru</code>,
                      create a file:
                    </p>
                    <div className="relative">
                      <pre className="bg-muted p-3 pb-4 rounded-md overflow-x-auto font-mono text-sm">
                  ...
                  <div>
                    <p className="mb-2">
                      If Archium fails to upgrade to a newer version:
                    </p>
                    <div className="relative">
                      <pre className="bg-muted p-3 pb-4 rounded-md overflow-x-auto font-mono text-sm">
                        yay -Scc --noconfirm && yay -S archium --noconfirm paru
                        -Scc --noconfirm && paru -S archium --noconfirm
                      </pre>
              ...
              <Card className="md:col-span-2">
                ...
                <CardContent className="space-y-4">
                  <p>
                    ...
                    <strong>GNU General Public License v3.0</strong>. See the{" "}
                    <Link
                      href="https://github.com/q4ow/archium/blob/main/LICENSE"
                      target="_blank"
                  ...
                  <p>
                    ...
                    <Link
                      href="https://github.com/q4ow/archium/fork"
                      target="_blank"
                      className="text-primary underline"
                    >
                      fork the repository
                    ...
                    <Link
                      href="https://github.com/q4ow/archium/issues"
                      target="_blank"
                      className="text-primary underline"
                    >
                      open an issue
                  ...
                  <p className="text-sm text-muted-foreground italic">
                    Disclaimer: Archium is not affiliated with Arch Linux or its
